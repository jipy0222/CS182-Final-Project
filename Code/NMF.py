...
def NMF(data, K, steps, alpha):
    ...
    user_pre, movie_weight, perf = matrix_factorization(user_pre,movie_weight,steps,alpha)
    
    return perf[-1]

for time in range(3):
    print(time, 10, 0.005, NMF(ratings_2,10,100,0.005))
#0 10 0.005 [0.78391508 0.8725053  2.22603805 0.60963385 0.69078848]
#1 10 0.005 [0.81127112 0.86241416 2.11699849 0.62837781 0.6920968 ]
#2 10 0.005 [0.77226497 0.83968305 2.10241517 0.61184384 0.67574229]